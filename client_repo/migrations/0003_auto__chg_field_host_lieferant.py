...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Host.lieferant'
        db.alter_column('client_repo_host', 'lieferant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['client_repo.Lieferant'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Host.lieferant'
        raise RuntimeError("Cannot reverse this migration. 'Host.lieferant' and its values cannot be restored.")
