...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Standort', fields ['name']
        db.delete_unique('client_repo_standort', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Standort', fields ['name']
        db.create_unique('client_repo_standort', ['name'])
