...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Haus.standort'
        db.add_column('client_repo_haus', 'standort',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['client_repo.Standort']),
                      keep_default=False)
