...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Host.ip'
        db.alter_column('client_repo_host', 'ip', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Host.mac'
        db.alter_column('client_repo_host', 'mac', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Host.ip'
        db.alter_column('client_repo_host', 'ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))

        # Changing field 'Host.mac'
        db.alter_column('client_repo_host', 'mac', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
    ...
    models = {
        ...
        'client_repo.host': {
            ...
            'ip': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'mac': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
